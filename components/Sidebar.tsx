...
const NAV = [
  ...
  { href: '/campanias',   label: 'Campañas',    icon: 'campanias'  },
    ...
    <aside className="w-52 h-full bg-white dark:bg-zinc-900 border-r border-gray-100 dark:border-zinc-800 flex flex-col">
      ...
      <div className="px-3 pb-3 space-y-3">
        {QUICK_LINKS.map(group => (
          <div key={group.group}>
            <p className="text-[10px] font-medium text-gray-400 dark:text-zinc-600 uppercase tracking-wider px-3 mb-1">{group.group}</p>
