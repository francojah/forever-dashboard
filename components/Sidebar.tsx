...
export default function Sidebar({ userEmail }: { userEmail: string }) {
  ...
  return (
    <aside className="w-52 bg-white dark:bg-zinc-900 border-r border-gray-100 dark:border-zinc-800 flex flex-col flex-shrink-0">
      ...
      <div className="px-5 pt-6 pb-5 border-b border-gray-100 dark:border-zinc-800">
        <div className="flex flex-col items-start gap-2">
          <Image
            ...
            unoptimized
          />
          <p className="text-[10px] tracking-widest text-gray-400 dark:text-zinc-500 uppercase font-medium">
            Ads Panel
          </p>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-5 space-y-0.5">
        {NAV.map(item => {
          ...
          return (
            ...
            >
              <span className={isActive ? 'text-gray-700 dark:text-white' : 'text-gray-400 dark:text-zinc-500'}>
      ...
      <div className="px-3 py-4 border-t border-gray-100 dark:border-zinc-800 space-y-1">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                     ...
                     transition-all duration-150"
        >
          <span className="text-gray-400 dark:text-zinc-500">{icons.logout}</span>
          Cerrar sesión
        </button>
      </div>
    </aside>
